...
-- <leader>pd — insert a Google-style docstring skeleton below the cursor
...
-- <leader>pc — insert a class skeleton (interactive)
...
-- <leader>pf — insert a function skeleton (interactive)
